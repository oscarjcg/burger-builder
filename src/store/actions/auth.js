...
export const auth = (email, password, isSignup) => {
    return dispatch => { 
        ...
        let url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCcdA2j-MoYmZAAVaq1QVI7XiG8LAdMH6o';
        if (!isSignup) {
            url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCcdA2j-MoYmZAAVaq1QVI7XiG8LAdMH6o';
        }
